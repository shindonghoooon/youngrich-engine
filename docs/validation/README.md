...
Authoritative for Results: linked validation documents only

Authoritative for Investment Rules: NO

Validation records what happened when frozen logic and code were exercised. It cannot
redefine thresholds, weights, formulas, or gates.
...
- [Limited Operating Independent Audit Response — LOCAL/REMOTE CI PASS](limited-operating-independent-audit-2026-09-06.md)
...
validation evidence rather than specifications.
